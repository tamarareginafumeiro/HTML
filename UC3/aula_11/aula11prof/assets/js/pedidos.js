...
historico_pedidos.map(dados_cliente => {
    ...
    document.getElementById("nome")
        .innerHTML = dados_cliente.nome_cliente

    //Mostrar o CPF no HTML
    document.getElementById("cpf")
        .innerHTML = dados_cliente.cpf

    //Mostrar o Data Nascimento no HTML
    document.getElementById("data-nasc")
    .innerHTML = dados_cliente.data_nasc
})
